...
:root {
  ...
  --size-h1: 76pt; --size-h2: 16pt; --size-h3: 13pt;
  --parrafo-gap: 5mm;
}
```

## Reglas propias
- **Una sola columna.** La palabra gigante baja a 76pt. El mosaico de fotos pasa a dos columnas como máximo: con tres, las imágenes quedan de 2cm.
